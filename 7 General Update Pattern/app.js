...
add.on("click", () => {
  ...
  let listItems = d3.select("#quotes").selectAll("li").data(quotes);

  listItems
    .enter() // At this point we have the new items only
    .append("li")
    ...
    .merge(listItems) // At this point we have all the items, not just the new ones
    .style("color", "blue");
...
removeBtn.on("click", function () {
  let nonRQuotes = quotes.filter(function (movie) {
